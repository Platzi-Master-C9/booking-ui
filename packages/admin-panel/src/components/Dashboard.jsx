...
export const Dashboard = () => {
  ...
  const { checked, setChecked, show, openFilters, setOpenFilters, handleSetShow, handleSetChecked, handleSetDelete, clicked, setClicked, setShow, handleClose } = useContext(ContextFilters)
 ...
 return (
    <section onClick={handleClose} className={styles.dashboard}>
      <h2>Users</h2>

...
export const LayoutAdministrators = ({ url }) => {
  ...
  const filterUsers = users.filter(
    (u) =>
      (checked.checkedOne && u.type === "Anfitrión") ||
      (checked.checkedTwo && u.type === "Administrador") ||
      (checked.checkedThree && u.status === "Activo") ||
      (checked.checkedFour && u.status === "Inactivo") ||
      (checked.checkedFive && u.validate === "Sí") ||
      (checked.checkedSixx && u.validate === "No")
  );
    ...
    <section className={styles.dashboard}>
      ...
      <div className={styles.filtersItem}>
        ...
        <div style={{ gridColumn: "2/3" }}>
          <CardContainer
            ...
            type={"Tipo"}
            titleOne="Anfitrión"
            titleTwo="Administrador"
            descriptionOne="Descripcion para anfitrion"
            descriptionTwo="Descripcion para Administrador"
            show={show.showOne}
            ...
            handleChexboxTwo={(e) =>
              handleSetChecked("checkedTwo", e.target.checked)
            }
            handleChexboxOneDelete={(e) =>
              handleSetDelete("checkedOne", "checkedTwo", false, false)
            }
          />
        </div>
        <div style={{ gridColumn: "3/4" }}>
          <CardContainer
            ...
            handleChexboxTwo={(e) =>
              handleSetChecked("checkedFour", e.target.checked)
            }
            handleChexboxOneDelete={(e) =>
              handleSetDelete("checkedThree", "checkedFour", false, false)
            }
          />
        </div>
        <div style={{ gridColumn: "4/5" }}>
          <CardContainer
            ...
            handleChexboxTwo={(e) =>
              handleSetChecked("checkedSixx", e.target.checked)
            }
            handleChexboxOneDelete={(e) =>
              handleSetDelete("checkedFive", "checkedSixx", false, false)
            }
          />
        </div>
      </div>
      <ul className={styles.list}>
        {filterUsers.length === 0
          ...
          : filterUsers.map((userFiltered) => <GridItem user={userFiltered} />)}
      </ul>
    </section>
  );
};
